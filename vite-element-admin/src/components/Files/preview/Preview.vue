...
<script setup>
import PreviewDoc from "@/components/Files/preview/PreviewDoc.vue";
import PreviewExcel from "@/components/Files/preview/PreviewExcel.vue";
import PreviewImage from "@/components/Files/preview/PreviewImage.vue";
import PreviewPdf from "@/components/Files/preview/PreviewPdf.vue";
import PreviewVideo from "@/components/Files/preview/PreviewVideo.vue";
import PreviewTxt from "@/components/Files/preview/PreviewTxt.vue";
import PreviewDownload from "@/components/Files/preview/PreviewDownload.vue";
import PreviewMusic from "@/components/Files/preview/PreviewMusic.vue";
