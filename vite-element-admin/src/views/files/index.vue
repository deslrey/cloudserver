    ...
    <div>
        <div class="top">
            <div class="top-op">
                ...
                <el-button type="success" @click="newFolder" v-if="category.includes('all')">
        ...
        <div class="no-data" v-else>
            <div class="no-data-inner">
                ...
                <div class="op-list">
                    ...
                    <div class="op-item" v-if="category.includes('all')" @click="newFolder">
...
const loadDataList = async () => {
    ...
    if (params.category.includes('all')) {
